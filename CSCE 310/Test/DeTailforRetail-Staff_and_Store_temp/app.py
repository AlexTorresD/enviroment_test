...
def updatestaff(feedback_message=None, feedback_type=False): #DONE BY ELVIS
    ...
    #     order_names = [name for name, _, _, _, _, _, _ in getorders()]
    return render_template("updatestaff.html", staffname=staff_name, feedback_message=feedback_message, feedback_type=feedback_type)
...
def deletestaff(feedback_message=None, feedback_type=False): #DONE BY ELVIS
    staff_name = [name for name ,_, _ in getstaff()]
    return render_template("deletestaff.html", staffname=staff_name, feedback_message=feedback_message, feedback_type=feedback_type)
...
def deletestore(feedback_message=None, feedback_type=False): #DONE BY ELVIS
    store_name = [name for name ,_, _ in getstore()]
    return render_template("deletestore.html", storename=store_name, feedback_message=feedback_message, feedback_type=feedback_type)
